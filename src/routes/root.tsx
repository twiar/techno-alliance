  ...
  return (
    <div className="h-dvh md:h-auto">
      ...
      <div className="h-full-16 md:h-dvh flex flex-column md:flex-row flex-wrap md:flex-nowrap overflow-hidden">
        <Link to="/voda" className="group/item w-full md:w-1/3 xl:w-1/3 bg-cover bg-center bg-no-repeat h-1/3 md:h-full relative overflow-hidden">
          <div className="absolute top-0 h-full flex flex-col justify-end z-20 pointer-events-none transition duration-500 group-hover/item:-translate-y-1">
            <h2 className="text-base md:text-3xl text-white p-4 w-4/5 font-bold">Оборудование для механической очистки стоков</h2>
          </div>
        ...
        <Link to="/linii" className="group/item w-full md:w-1/3 xl:w-1/3 bg-cover bg-center bg-no-repeat h-1/3 md:h-full relative overflow-hidden">
          <div className="absolute top-0 h-full flex flex-col justify-end z-20 pointer-events-none transition duration-500 group-hover/item:-translate-y-1">
            <h2 className="text-base md:text-3xl text-white p-4 w-4/5 font-bold">Технологические линии и оборудование для получения мясокостной муки</h2>
          </div>
        ...
        <Link to="/transport" className="group/item w-full md:w-1/3 xl:w-1/3 bg-cover bg-center bg-no-repeat h-1/3 md:h-full relative overflow-hidden">
          <div className="absolute top-0 h-full flex flex-col justify-end z-20 pointer-events-none transition duration-500 group-hover/item:-translate-y-1">
            <h2 className="text-base md:text-3xl text-white p-4 w-4/5 font-bold">Специальная техника для транспортировки биологического сырья</h2>
          </div>
