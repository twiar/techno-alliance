    ...
    <div className="h-dvh">
      ...
      <section className="h-32 bg-primary flex justify-center items-center">
        <div className="text-center relative z-20 text-white w-1/2">
          <h2 className="text-5xl mb-8 font-lt-superior font-bold text-white">О компании</h2>
        </div>
      ...
      <div className={`relative h-16 bg-light flex justify-center items-center px-4`}>
