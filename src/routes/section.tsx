...
export default function Section() {
  const sections = [
    {
      section: {
        title: 'Технологические линии и оборудование для получения мясокостной муки',
        link: '',
        children: [
          {
    ...
    <div className="h-dvh">
      ...
      <section className="h-96 md:h-full-64 bg-primary flex justify-center items-end">
        <div className="text-center mb-4 md:mb-16 relative z-20 text-white w-full md:w-1/2">
          <h2 className="text-2xl md:text-5xl mb-4 md:mb-8 font-bold text-white"></h2>
            ...
            <div className="flex flex-col gap-8 mb-10">
              <div className="flex gap-8 flex-col md:flex-row">
                <Link to="/product" className="block md:h-96 md:w-96 bg-white relative group/item overflow-hidden">
                  <img alt="Здание решеток и КНС" src={firstSectionImg} className="object-cover w-full h-64 md:h-96 transition duration-500 group-hover/item:scale-105" />
